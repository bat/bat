...
//      void PrintHistogram(const char * options = "", const char * filename = "");
       ...
       * @return An error code */
      int CalculatePValueFast(const std::vector<double> & par, BCHistogramFitter::ToyDataInterface * callback,
            double & pvalue, double & pvalueCorrected, unsigned nIterations = 100000);
