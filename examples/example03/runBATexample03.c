...
int main()
{
	...
	fModelManager -> SetDataBoundaries(1, 0., 20);
	...
	fModelManager -> PrintSummary("summary.txt");
	...
	TH1D * hist_data = new TH1D("hist_data", ";E;N", Nbins, Emin, Emax);
	...
	func_sgn -> SetParameter(2, 2.);
	func_sgn -> SetParameter(3, 2039.);
