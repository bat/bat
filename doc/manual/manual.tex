...
\author{A.~Caldwell$^{1}$, D.~Kollar${^2}$, K.~Kr{\"}oninger$^{3}$} 

\maketitle

\begin{center}
$^{1}$~Max-Planck-Institut f{\"}ur Physik, Munich \\ 
$^{2}$~CERN, Geneva
$^{3}$~II.~Physikalisches Institut, Universit{\"}at G{\"}ottingen \\ 
\end{center}
