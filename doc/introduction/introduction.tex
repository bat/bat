...
Another way of calculating the $p$-value also uses MCMC:
%
\begin{verbatim}
...
%
\noindent 
For this to work, the ranges of the possible data values have to be
set using
%
\begin{verbatim}
...
\end{verbatim}
%
where the option \verb|fixed| indicates if the data values shuold be
fixed to their values during the calculatiion of the $p$-value. This
is useful, e.g., for fitting a function for fixed $x$-values. 
