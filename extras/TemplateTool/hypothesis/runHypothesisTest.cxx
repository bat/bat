...
int main()
{
	...
	TemplateModel * m_1bkg0sgn = new TemplateModel("model 1 bkg 0 sgn");
	...
	TemplateModel * m_1bkg1sgn = new TemplateModel("model 1 bkg 1 sgn");
	...
	// create new TemplateModel object
	TemplateModel * m_2bkg0sgn = new TemplateModel("model 2 bkg 0 sgn");
	...
	// create new TemplateModel object
	TemplateModel * m_2bkg1sgn = new TemplateModel("model 2 bkg 1 sgn");
