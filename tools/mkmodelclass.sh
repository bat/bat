...
//		double LogConditionalProbabilityEntry(BCDataPoint* datapoint, std::vector <double> parameters);

//		double LogPoissonProbability(int nentries, std::vector <double> parameters);
...
{
// Put the code for calculating natural logarithm of the Likelyhood
// p(data|params) here.
// Alternatively you can overload the methods LogConditionalProbabilityEntry
// and LogPoissonProbability below and comment out this method.
// See BAT documentation for more details.
...
// input the code for calculating probability here
...
{
// Put the code for calculating natural logarithm of the Prior probability
// p_0(params) here.
...
// ---------------------------------------------------------
// ---------------------------------------------------------
// Alternatively to overloading the LogLikelihood method, you can overload
// the two methods below. In this case you have to comment out the
// LogLikelihood method in this file as well as in the header file.
// If you use these methods the likelihood is then calculated as a product
// of LogConditionalProbabilityEntry() for individual data points times
// LogPoissonProbability(). See BAT documentation for more details.
//
/*
// ---------------------------------------------------------
double |:Model:|::LogConditionalProbabilityEntry(BCDataPoint* datapoint,
...
// ---------------------------------------------------------
double |:Model:|::LogPoissonProbability(int nentries,
          std::vector <double> parameters)
{
	double logprob = 0.;
